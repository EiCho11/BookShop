...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <?php include 'nav.php'; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Authors Type</h1>
           <a href="#add" class="btn btn-success" data-toggle="modal">Add New Author</a>
          <table class="table">
            <thead>
              <tr>
                <th>No</th>
              ...
              <tr>
                ...
                <td>
                  <a href="#" class="edit btn btn-warning btn-circle btn-sm" data-id="<?php echo $row['id']; ?>"  data-name="<?php echo $row['name']; ?>"><i class="fas fa-exclamation-triangle" ></i></a>
  ...
  <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Author List</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        ...
        <div class="modal-body">
          <input type="text" name="name" class="form-control" placeholder="Enter Author Name ...."></div>
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
