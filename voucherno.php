    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <?php include 'nav.php'; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Voucher Record</h1>

           <div class="col-md-10 offset-md-1">
           	<p>
           		<span>Vouvher No: <?=$vno ?></span>
           		<span class="float-right">Order Date: <?=$odate ?></span>
           	</p>
         ...
         <table class="table">
            ...
            <tbody>
              <?php 
                      ...
                      $sql = "SELECT orderdetails.*,books.name as bookname,books.price as bookprice FROM orderdetails INNER JOIN books on orderdetails.book_id=books.id where voucherno='$vno'";
                      $result=$conn->query($sql);
                      //var_dump($result);
                      if ($result->num_rows>0) {
                          $i=1; $total=0;
                          while ($row=$result->fetch_assoc()){
                          	$subtotal = $row['qty'] *$row['bookprice'];
                          	$total+=$subtotal;
                          //  var_dump($row);
                            ?>
              <tr>
